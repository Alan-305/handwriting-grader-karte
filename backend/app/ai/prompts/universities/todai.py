...
## 本文の要件
- **語数**: **700〜900語**（英語）。650語未満・950語超は不合格
- **完結**: 物語・随筆として**最後まで書き切る**。途中で切れないこと
- **最終文**: 必ず **. ! ?** で終わる完全な英文で締める（"The editors praised his" のような途中切断は禁止）
...
- **fullTranslationJa は出力しない**（空文字 "" のまま。本文全訳は下書き画面で後から手動生成する）
